...
scp CD146976-L-FW01-GPSCONECTA:/etc/init.d/firewall /etc/init.d/firewall

sed -i 's/ssh CD146976-L-FW01-GPSCONECTA-RJ/#ssh CD146976-L-FW01-GPSCONECTA-RJ/g' /etc/init.d/firewall
