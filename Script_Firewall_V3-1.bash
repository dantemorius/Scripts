...
yum install vim mlocate telnet wget -y
...
sed -i 's/daniel\.cid\@\example\.com/operacoes@mandic.net.br/' /var/ossec/etc/ossec.conf
sed -i 's/smtp\.example\.com\./localhost/' /var/ossec/etc/ossec.conf
sed -i 's/ossecm\@ossec\.example\.com\./ossec-'$NOME1'@mandic.net.br/' /var/ossec/etc/ossec.conf
...
core1="177.70.104.184,177.70.117.198,177.70.118.10,177.70.121.201,177.70.122.13,177.70.125.10,187.191.96.5,187.191.98.5,177.70.106.41"
core2="177.70.104.194,177.70.117.199,177.70.118.11,177.70.121.202,177.70.122.15,177.70.125.11,187.191.96.151,187.191.98.30,187.191.101.186,177.70.106.42"
core3="177.70.104.204,177.70.117.200,177.70.118.12,177.70.121.213,177.70.122.17,177.70.125.12,187.191.96.202,187.191.98.31,187.191.101.189,187.191.125.132,177.70.106.227"
core4="177.70.104.205,177.70.117.201,177.70.118.13,177.70.121.214,177.70.122.18,177.70.125.13,187.191.96.203,187.191.98.35,187.191.101.190,187.191.125.133,177.70.106.228"
core5="177.70.104.210,177.70.117.202,177.70.118.14,177.70.121.250,177.70.122.21,177.70.125.14,187.191.101.170,177.70.125.16,187.191.96.156,187.191.98.158,177.70.106.229"
core6="177.70.104.211,177.70.117.203,177.70.118.15,177.70.121.251,177.70.122.22,177.70.125.15,187.191.101.188,177.70.125.17,187.191.96.184,187.191.99.155,177.70.106.230"
core7="177.70.104.212,177.70.125.22,177.70.121.201,177.70.121.202,177.70.122.39,177.70.122.40,187.191.96.153,187.191.98.36,177.70.116.146,177.70.118.16,187.191.101.186,177.70.106.87"
core8="177.70.104.214,177.70.125.23,177.70.121.213,177.70.121.214,177.70.122.45,177.70.122.46,187.191.96.158,187.191.98.39,177.70.117.45,177.70.118.17,187.191.101.189,177.70.106.88"
core9="177.70.104.217,177.70.121.249,177.70.122.48,187.191.96.182,187.191.98.25,177.70.117.46,177.70.118.18,187.191.101.201,177.70.106.89,192.168.0.24"
all_cores="$core1,$core2,$core3,$core4,$core5,$core6,$core7,$core8"
...
$IPTABLES -A INPUT -s $all_cores -p tcp -m multiport --dport 9006:9010 -j ACCEPT
$IPTABLES -A INPUT -s $all_cores -p tcp -m multiport --dport 9100:9300 -j ACCEPT
##########################################################################################
...
#Gerenciamento
$IPTABLES -A FORWARD -s 177.70.100.20 -p tcp --dport 3389 -j ACCEPT
$IPTABLES -A FORWARD -s 177.70.100.5 -p tcp --dport 22 -j ACCEPT
$IPTABLES -A FORWARD -p udp -s 177.70.106.7 --dport 514 -j ACCEPT


##############################Regras AppAssure/RapidRecovery##############################
$IPTABLES -A FORWARD -s $all_cores -p tcp -m multiport --dport 9006:9009 -j ACCEPT
$IPTABLES -A FORWARD -s $all_cores -p tcp -m multiport --dport 9100:9300 -j ACCEPT
##########################################################################################
...
echo '$IPTABLES' "-t nat -A POSTROUTING -s $BACKEND/24 -d zbx.mandic.net.br -p tcp --dport 10052 -j SNAT --to $VIP" >> $ARQNAT
REGRAS=`cat $ARQNAT`
...
# INSTALACAO REPOSITORIO EPEL & ATOMIC - FW02
        sshpass -p $PASSWDFW02 ssh root@$NODE2 "yum install vim mlocate telnet wget -y"
...
echo '##Otimização de leitura e escrita:
vm.dirty_background_ratio = 5
vm.dirty_ratio = 10
net.core.somaxconn = 1024
net.core.netdev_max_backlog = 2500
