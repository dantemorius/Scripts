...
# Inslanado versãdo PHP
prompt="Qual versãde PHP deseja instalar:"
options=( "PHP 5.6" "PHP 5.5" "PHP 5.4" "PHP 5.3" "Exit" )
echo "========================================================================="
echo "                      Selecione a Versãdo PHP           "
echo "========================================================================="
...
select opt in "${options[@]}" ; do
    ...
    4) yum -y install php php-cli php-common php-mysql php-bcmath php-dba php-devel php-embedded php-imap php-ldap php-mbstring php-mcrypt php-pdo php-soap && clear && exit 1 ;;
    5) clear && echo "Cancelando..." && exit;;
    *) echo "por favor selecione uma das opçs";continue;;
