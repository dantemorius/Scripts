...
ajuste_interface(){
echo -n "Informe a interface que receberá o IP de backend: (Ex: eth1, eth2) "
        read eth
        export eth


echo -n "Informe o IP's BACKEND: "
        read BACKEND
        export BACKEND
...
BOOTPROTO=static
IPADDR='$BACKEND'
NETMASK=255.255.255.0' > /etc/sysconfig/network-scripts/ifcfg-$eth
...
echo ""
echo -e "\\033[1;39m \\033[1;32mSelinux como Permissive\\033[1;39m \\033[1;0m"
echo ""
}
...
#       PHP70
    rpm -Uvh https://dl.fedoraproject.org/pub/epel/epel-release-latest-6.noarch.rpm
        yum -y --enablerepo=remi,remi-php70 install httpd httpd-devel php php-devel php-gd php-imap php-ldap php-mysql php-odbc php-pear php-xml php-xmlrpc php-mbstring php-mcrypt php-mssql php-snmp php-soap php-tidy curl curl-devel perl-libwww-perl ImageMagick libxml2 libxml2-devel mod_fcgid php-cli php-ZendFramework memcached php-pecl-memcache libevent-last php-pecl-igbinary php-pecl-igbinary-devel mod_ssl php-pecl-memcached && clear ;;
        *)
        inslanado_versao_do_php_e_httpd
        ;;
        esac
...
useradd -G apache -d $DIRFTP -s /sbin/nologin $USUARIOFTP

##Adicionando usuário ao grupo do Apache
#chgrp -a -G apache $USUARIOFTP
##Alterando propriedade do diretório raiz do FTP
chmod 775 -R $DIRFTP
chown -R $USUARIOFTP:apache $DIRFTP
